...
| S3 | **MainWindow ~4.3k LOC** | Menus partially centralized | **Partial** — +location_menu_helpers, file_context_menu, location_icons/url, ArchiveListing, archive_member_cache, theme_icons |
