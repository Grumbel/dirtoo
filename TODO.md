...
| S3 | **MainWindow ~4.3k LOC** | Menus partially centralized | **Partial** — +file_context_menu, location_icons/url, ArchiveListing, archive_member_cache, theme_icons; controllers |
