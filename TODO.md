...
- [ ] **D4 — Shared HashService** — Foundation: process-wide `HashService` (mutex + ChecksumStore); TagJob uses ensure/get/put. Still open: queue for concurrent hash CPU, ChecksumDialog wire-up, idle scanner.
