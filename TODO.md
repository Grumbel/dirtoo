...
| S3 | **MainWindow ~4.4k LOC** | Menus partially centralized | **Partial** — +file_context_menu, ArchiveListing, archive_member_cache, theme_icons; NavigationHistory, Search, Transfer, Devices |
